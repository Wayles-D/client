...
const Chicken = ({ handleAddToCart }) => {
  // Find the Chicken category
  const chickenCategory = foodData.find((category) => category.category === "Chicken");
      ...
      <div className="w-full">
        <section className="mb-5 mt-0 pb-0">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {chickenCategory?.items.map((item) => (
              <div
                key={item._id}
