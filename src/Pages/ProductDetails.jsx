      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <button
            ...
            className="mt-6 w-full max-w-[300px] h-12 rounded-[31px] bg-[#B67B0F] text-white font-bold border-none shadow-none cursor-pointer transition duration-300 hover:bg-white hover:text-black"
          >
            Add To Cart
          </button>
        </div>
